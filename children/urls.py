...
urlpatterns = [
    ...
    path("relationships/all/", views.RelationshipListView.as_view(), name="relationship_list"),
    ...
    path("relationships/", views.RelationshipByUserListView.as_view(), name="relationship_by_user_list"),
    path("add/", views.ChildCreateView.as_view(), name="create"),
    path("all/", views.ChildListView.as_view(), name="list"),
    path("<slug:slug>/children/", views.ChildrenByUserListView.as_view(), name="by_user_list"),
