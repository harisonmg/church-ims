...
class AdminTestCase(FunctionalTestCase):
    ...
    def test_that_a_staff_can_manage_children(self):
        ...
        self.assertEqual(children_rows[1].text, "AbigaelAuma Abigael Auma 6 Female")
        self.assertEqual(children_rows[2].text, "BrianKimani Brian Kimani 2 Male")
        ...
        relationships_form = self.browser.find_element_by_id(
            "parentchildrelationship_form"
        )
        relationships_form.find_element_by_name("parent").find_elements_by_tag_name(
            "option"
        )[1].click()
        ...
        child_form.find_element_by_name("gender").find_elements_by_tag_name("option")[
            1
        ].click()
        child_form.find_element_by_name("created_by").find_elements_by_tag_name(
            "option"
        )[1].click()
        ...
        relationships_form.find_element_by_name(
            "relationship_type"
        ).find_elements_by_tag_name("option")[1].click()
        relationships_form.find_element_by_name("created_by").find_elements_by_tag_name(
            "option"
        )[1].click()
