...
class AdminTestCase(FunctionalTestCase):
    ...
    def test_that_a_staff_can_manage_people(self):
        ...
        self.assertEqual(
            self.browser.find_element_by_link_text("Relationship types").get_attribute(
                "href"
            ),
        ...
        self.assertEqual(people_rows[1].text, "AbigaelAuma Abigael Auma 6")
        self.assertEqual(people_rows[2].text, "AlvinMukuna Alvin Mukuna 36")
        self.assertEqual(people_rows[3].text, "BrianKimani Brian Kimani 2")
        self.assertEqual(people_rows[4].text, "ChristineKyalo Christine Kyalo 29")
        self.assertEqual(people_rows[5].text, "Kelvin Kelvin Murage 26")
        ...
        relatives = relationships_inline.find_elements_by_css_selector(
            ".field-relative"
        )
        ...
        person_form.find_element_by_name("gender").find_elements_by_tag_name("option")[
            1
        ].click()
        person_form.find_element_by_name("created_by").find_elements_by_tag_name(
            "option"
        )[1].click()
        ...
        relationships_inline = self.find_relationships_inline()
        relationship_types = relationships_inline.find_elements_by_css_selector(
            ".field-relationship_type"
        )
        relationship_types[-2].find_elements_by_tag_name("option")[1].click()

        created_by_fields = relationships_inline.find_elements_by_css_selector(
            ".field-created_by"
        )
